...
resource "aws_route_table" "private" {
  ...
  # Route through NAT Gateway if enabled, otherwise through Internet Gateway (dev only)
  dynamic "route" {
...
# VPC Endpoint for S3 (cost savings)
...
# VPC Endpoint for ECR API (required for ECS to pull images)
...
# VPC Endpoint for Secrets Manager (required for ECS to fetch secrets)
...
# VPC Endpoint for CloudWatch Logs (required for ECS to send logs)
